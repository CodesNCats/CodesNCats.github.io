...
if (isset($_POST["C"])) {
	setcookie("HZ[C]", $_POST["C"], time()+24*3600, "/", ".drakewellcoffee.com");
	setcookie("HZ[G]", $_POST["G"], time()+24*3600, "/", ".drakewellcoffee.com");
	setcookie("HZ[W]", $_POST["W"], time()+24*3600, "/", ".drakewellcoffee.com");
...
<style>
.pan{
	background-image:url(../Images/Panoramic_Strips/hazelnut.jpg);
}
.itemTitle{
	color:#735123;
}
...
<div class="cut"></div>
    ...
    <div class="pan">
        	...
        	<a id="prev" href="cappuccino.php"></a> <a id="next" href="decaf.php"></a>
            <!-- InstanceEndEditable -->
            ...
            Hazelnut
                ...
                Smell: Deep, Rich, Sweet, Hazelnut<br />
