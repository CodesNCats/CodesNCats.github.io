...
if (isset($_POST["C"])) {
	setcookie("CP[C]", $_POST["C"], time()+24*3600, "/", ".drakewellcoffee.com");
	setcookie("CP[G]", $_POST["G"], time()+24*3600, "/", ".drakewellcoffee.com");
	setcookie("CP[W]", $_POST["W"], time()+24*3600, "/", ".drakewellcoffee.com");
...
<style>
.pan{
	background-image:url(../Images/Panoramic_Strips/cappuccino.jpg);
}
.itemTitle{
	color:#bfbdcd;
}
...
<div class="cut"></div>
    ...
    <div class="pan">
        	...
        	<a id="prev" href="seb.php"></a> <a id="next" href="hazelnut.php"></a>
            <!-- InstanceEndEditable -->
            ...
            Cappuccino
                ...
                Color: Light, Frothy<br />

                Taste: Sweet, Nutty, Soy, Vanilla<br />

                Smell: Milky, Sweet<br />
