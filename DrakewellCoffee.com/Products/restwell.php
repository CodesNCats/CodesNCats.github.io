...
if (isset($_POST["C"])) {
	setcookie("RW[C]", $_POST["C"], time()+24*3600, "/", ".drakewellcoffee.com");
	setcookie("RW[G]", $_POST["G"], time()+24*3600, "/", ".drakewellcoffee.com");
	setcookie("RW[W]", $_POST["W"], time()+24*3600, "/", ".drakewellcoffee.com");
...
<style>
.pan{
	background-image:url(../Images/Panoramic_Strips/restwell.jpg);
}
.itemTitle{
	color:#7dd1ed;
}
.box #prev:hover, .box #next:hover{
	background-color:#7dd1ed;
	border-color:#7dd1ed;
}
.typeImage1{
...
<div class="cut"></div>
    ...
    <div class="pan">
        	...
        	<a id="prev" href="breakfast_blend.php"></a> <a id="next" href="sleepwell.php"></a>
            <!-- InstanceEndEditable -->
        ...
        <div class="typeDescription f2">
            ...
            <span class="typeCost">
            	<!-- InstanceBeginEditable name="Cost1" -->
                	<span class="logedHide">$15.99</span><span class="logedShow"></span>
                <!-- InstanceEndEditable -->
            </span>
            
            <span class="typeSize">
            	<!-- InstanceBeginEditable name="Size1" -->
                	<span class="logedHide">18 Cups</span><span class="logedShow"></span>
                <!-- InstanceEndEditable -->
            </span>
        ...
        <div class="typeDescription f2">
            ...
            <span class="typeCost">
            	<!-- InstanceBeginEditable name="Cost2" -->
                	<span class="logedHide">$12.99</span><span class="logedShow"></span>
                <!-- InstanceEndEditable -->
            </span>
