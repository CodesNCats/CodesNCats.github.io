...
if (isset($_POST["C"])) {
	setcookie("BB[C]", $_POST["C"], time()+24*3600, "/", ".drakewellcoffee.com");
	setcookie("BB[G]", $_POST["G"], time()+24*3600, "/", ".drakewellcoffee.com");
	setcookie("BB[W]", $_POST["W"], time()+24*3600, "/", ".drakewellcoffee.com");
...
<style>
.pan{
	background-image:url(../Images/Panoramic_Strips/breakfast_blend.jpg);
}
.itemTitle{
	color:#4ab646;
}
...
<div class="cut"></div>
    ...
    <div class="pan">
        	...
        	<a id="prev" href="hot_chocolate.php"></a> <a id="next" href="restwell.php"></a>
            <!-- InstanceEndEditable -->
