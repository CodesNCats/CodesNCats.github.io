...
if (isset($_POST["C"])) {
	setcookie("HC[C]", $_POST["C"], time()+24*3600, "/", ".drakewellcoffee.com");
	setcookie("HC[G]", $_POST["G"], time()+24*3600, "/", ".drakewellcoffee.com");
	setcookie("HC[W]", $_POST["W"], time()+24*3600, "/", ".drakewellcoffee.com");
...
<style>
.pan{
	background-image:url(../Images/Panoramic_Strips/hot_chocolate.jpg);
}
.itemTitle{
	color:#ab7668;
}
...
<div class="cut"></div>
    ...
    <div class="pan">
        	...
        	<a id="prev" href="decaf.php"></a> <a id="next" href="breakfast_blend.php"></a>
            <!-- InstanceEndEditable -->
            ...
            Hot Chocolate
                ...
                Color: Creamy, Milky<br />

                Taste: Milky, Chocolaty<br />

                Smell: Sweet, Chocolaty<br />

                Texture: Smooth, Rich, Thick
