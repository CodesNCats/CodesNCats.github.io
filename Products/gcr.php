...
if (isset($_POST["C"])) {
	setcookie("CB[C]", $_POST["C"], time()+24*3600, "/", ".drakewellcoffee.com");
	setcookie("CB[G]", $_POST["G"], time()+24*3600, "/", ".drakewellcoffee.com");
	setcookie("CB[W]", $_POST["W"], time()+24*3600, "/", ".drakewellcoffee.com");
...
<style>
.pan{
	background-image:url(../Images/Panoramic_Strips/colombia.jpg);
}
.itemTitle{
	color:#ec1e28;
}
...
<div class="cut"></div>
    ...
    <div class="pan">
        	...
        	<a id="prev" href="sleepwell.php"></a> <a id="next" href="seb.php"></a>
            <!-- InstanceEndEditable -->
