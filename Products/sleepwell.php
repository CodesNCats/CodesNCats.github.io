...
if (isset($_POST["C"])) {
	setcookie("SW[C]", $_POST["C"], time()+24*3600, "/", ".drakewellcoffee.com");
	setcookie("SW[G]", $_POST["G"], time()+24*3600, "/", ".drakewellcoffee.com");
	setcookie("SW[W]", $_POST["W"], time()+24*3600, "/", ".drakewellcoffee.com");
...
<style>
.pan{
	background-image:url(../Images/Panoramic_Strips/sleepwell.jpg);
}
.itemTitle{
	color:#70408a;
}
...
<div class="cut"></div>
    ...
    <div class="pan">
        	...
        	<a id="prev" href="restwell.php"></a> <a id="next" href="gcr.php"></a>
            <!-- InstanceEndEditable -->
